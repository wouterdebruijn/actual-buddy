 ...
 */
/** biome-ignore-all lint/suspicious/noExplicitAny: autogen file */
...
export type AccountResponse<Texpand = unknown> = Required<AccountRecord> &
	BaseSystemFields<Texpand>;
export type BudgetResponse<Texpand = unknown> = Required<BudgetRecord> &
	BaseSystemFields<Texpand>;
export type SessionResponse<Texpand = unknown> = Required<SessionRecord> &
	BaseSystemFields<Texpand>;
export type UserResponse<Texpand = unknown> = Required<UserRecord> &
	BaseSystemFields<Texpand>;
export type UsersResponse<Texpand = unknown> = Required<UsersRecord> &
	AuthSystemFields<Texpand>;
export type VerificationResponse<Texpand = unknown> =
	Required<VerificationRecord> & BaseSystemFields<Texpand>;
